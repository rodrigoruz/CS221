...
URL_BASE = "https://oyaop.com/opportunities/competitions-and-awards/"
Fecha_Final = "-"
premio="-"
remuneracion ="-"
costo="-"
    ...
    if statusCode == 200:
        ...
        for j, entrada in enumerate(links):
            ...
            if (j != 5) and (j != 11):
                ...
                df.to_csv('OYA_CompetitionsAndAwards.csv', encoding='utf-8-sig') #The encoding allows for writing special characters
                #df.to_csv('OYA.csv')
                # else:
                #   print(status_code)
